...
const getshipmentData = async () => {
    const getData = await getShipmeht(index) ;
    setSingleShipmentData ( getData) ;
    console. log (getData) ;
};
console. tog ( singleShipmentData) ;
...
<button
className=" p-2  text-gray-400 rounded-md hover: bg-g ray-100"
onClick={() => setGetModel(false)}
>
<svg
...
>
    ...
    d="M4.293 4.293a1 1 0 011.414 0L10 8.58614.293-4.293a1 1 0 111.414 1.
       414L11.414 10l4.293 4.293a1 1 01-1.414 1.414L10 11.414l-4.293 4.
