...
<div className=" relative mt-3">
    ...
    className="w-full lt-5 pr-3 py-2 0 text-gray-5Ø0 bg-transparent
    outline-none border O focus: border-indigo-60 shadow-sm rounded-lg"
    onChange={(e) =>
    setGetProduct({
    ...getProduct,
...
/>
    ...
    text-white bg-indigo-600 active:bg-indigo-700
